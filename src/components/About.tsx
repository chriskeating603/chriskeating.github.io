...
const About = () => {
  ...
  return (
    ...
    >
        ...
        <Typography variant="h4" component="h1" sx={{ fontFamily: "'Helvetica Neue', monospace", textDecoration: 'underline' }}>
          Hey, I'm Chris!
        </Typography>
