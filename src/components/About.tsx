    ...
    >
      <Grid item xs={6} sx={{ flex: 1, textAlign: 'center' }}>
        ...
        <Typography variant="h6" sx={{ fontFamily: "'Helvetica Neue', monospace", padding: '20px 0 40px 0' }}>
          ...
          I'm a founder currently building in the intersection of Athletics + Data Science/AI  - two areas of personal passion and expertise for me. Winning a Division 1 National Championship in Men's Lacrosse at Yale and going on to play professionally made me competitive and driven in my pursuits. I continue to compete through triathlons and running races today. Meanwhile, working as a data scientist at Twitter and 2 startups has made me super-rational and disciplined when analyzing and making decisions. I’m combining these experiences as I build my next venture - please <a style={{color: '#7d7f7c', textDecoration: 'underline'}} href="mailto:ckeating.nh@gmail.com" >email me</a> if you want to chat about Athletics + Data!
        </Typography>
      </Grid> 
      <Grid item xs={1}></Grid>
